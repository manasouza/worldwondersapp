package com.curso.android.ciant.worldwondersapp.contentprovider;

import com.curso.android.ciant.worldwondersapp.database.Database;
...
public class WorldWondersContentProvider extends ContentProvider {
	...
	private static final String AUTHORITY = "com.curso.android.ciant.worldwondersapp";
    ...
    private static final class PlaceContent implements BaseColumns {
        ...
        /**
         * Specifies the content path of the PlaceTable for the required Uri.
         */
   ...
   public final boolean onCreate() {
	   ...
	   /**
	    * Instancia o banco de dados quando o content provider for criado.
	    */
        ...
        try {
            ...
            switch (URI_MATCHER.match(uri)) {
                ...
                case PLACE_ID:
                    ...
                    Uri newPost = ContentUris.withAppendedId(PLACE_CONTENT_URI, postId);
